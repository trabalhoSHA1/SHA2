...
export default function AdminAppointmentsPage() {
  ...
  // Simula fetch de todos os compromissos
  useEffect(() => {
    // Futuramente: buscar do banco de dados
    setAppointments(appointmentsMock);
  }, []);

  // Filtra por data, tipo e pesquisa
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-1">Gerenciamento de Consultas</h1>
          <p className="text-gray-600">Visualize e gerencie todos os compromissos</p>
        </div>
        <Button onClick={handleNewAppointment} className="mt-4 sm:mt-0 flex items-center gap-2 bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-lg">
