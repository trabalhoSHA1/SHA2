...
import { Clock, User, MapPin, Video, Phone, Mail } from 'lucide-react';
import { Button } from '@/components/ui/button';

export default function AppointmentCard({ appointment, showTherapist }) {
  ...
  return (
    <div className="p-4 sm:p-6 hover:bg-gray-50 transition-colors border-b border-gray-200 flex flex-col sm:flex-row sm:items-center gap-4">
